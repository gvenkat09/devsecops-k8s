pipeline {
  ...
  stages {
    ...
    stage('Sonar Qube - SAST') {
      steps {
        sh "mvn sonar:sonar -Dsonar.projectKey=numeric-application -Dsonar.host.url=http://15.206.37.128:9000 -Dsonar.login=a040b2423eeb1ae387908c63b8812b891a62735f"
      }
    }
